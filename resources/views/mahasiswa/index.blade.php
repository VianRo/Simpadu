...
<div class="container mt-5 bg-dark text-light rounded-4 py-4">
    ...
    @elseif (!empty($status) && $status == 'deleted')
        <div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    <div class="card bg-secondary text-light">
        ...
        <div class="card-body bg-dark text-light">
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" id="searchInput" class="form-control bg-dark text-light border-secondary" placeholder="Cari Mahasiswa...">
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-dark" id="mahasiswaTable">
